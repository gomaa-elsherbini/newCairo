        ...
        <div class="main-container">
                ...
                <div class="row align-items-center">
                    <div class="col-lg-6">
                        <div class="text-aboutus">
                            <h2 class="title-start1">نظام إنذار الحريق</h2>
                            <p>نحن متخصصون في توريد وتركيب واختبار وصيانة العديد من العلامات التجارية العالمية
                                لأنظمة إنذار الحريق ذات السمعة الجيدة لتلبية الإحتياجات التي تناسب جميع المجالات
                                للصناعات عالية المخاطر وكذلك جميع الابتكارات المتقدمة تقنيًا و التي لها قيمة
                                كبيره طوال فترة المنتج بالكامل.</p>
                        </div>
                    </div>

                    <div class="col-lg-6">
                        <div class="img-aboutus">
                            <object data="{{asset('frontend/assets/svg/h-6.svg')}}" type="">
                                <img src="{{asset('frontend/assets/svg/h-6.svg')}}" alt="">
                            </object>
                        </div>
                    </div>
                </div>
            ...
            <div class="sub-solutions sub-aboutus">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="img-aboutus">
                            <object data="{{asset('frontend/assets/svg/h-3.svg')}}" type="">
                                <img src="{{asset('frontend/assets/svg/h-3.svg')}}" alt="">
                            </object>
                        </div>
                    </div>
                </div>
            ...
            <div class="sub-solutions sub-aboutus">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="img-aboutus">
                            <object data="{{asset('frontend/assets/svg/h-5.svg')}}" type="">
                                <img src="{{asset('frontend/assets/svg/h-5.svg')}}" alt="">
                            </object>
                        </div>
                    </div>
                </div>
            ...
            <div class="sub-solutions sub-aboutus">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="img-aboutus">
                            <object data="{{asset('frontend/assets/svg/h-4.svg')}}" type="">
                                <img src="{{asset('frontend/assets/svg/h-4.svg')}}" alt="">
                            </object>
                        </div>
                    </div>
                </div>
            ...
            <div class="sub-solutions sub-aboutus">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="img-aboutus">
                            <object data="{{asset('frontend/assets/svg/h-7.svg')}}" type="">
                                <img src="{{asset('frontend/assets/svg/h-7.svg')}}" alt="">
                            </object>
                        </div>
                    </div>
                </div>
            ...
            <div class="sub-solutions sub-aboutus">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="img-aboutus">
                            <object data="{{asset('frontend/assets/svg/h-2.svg')}}" type="">
                                <img src="{{asset('frontend/assets/svg/h-2.svg')}}" alt="">
                            </object>
                        </div>
                    </div>
                </div>
            ...
            <div class="sub-solutions sub-aboutus">
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6">
                        <div class="img-aboutus">
                            <object data="{{asset('frontend/assets/svg/h-1.svg')}}" type="">
                                <img src="{{asset('frontend/assets/svg/h-1.svg')}}" alt="">
                            </object>
                        </div>
                    </div>
                </div>
